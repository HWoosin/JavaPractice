...
public class LottoSimulator {
	...
	public static void createLotto(List<Integer> makelotto) {
		/*
	...
	//보너스 번호
	public static int createBonusNum(List lotto) {
		/*
	...
	//당첨 등수알려주는 메서드
	public static int checkLottoNumber(List myLotto, List lotto, int bonus ) {
		/*
	...
	public static void main(String[] args) {
		...
		createLotto(myLotto);//내꺼
		List<Integer> lotto = new ArrayList<>();//로또돌리기
		int bonus = 0;//보너스
		int tries = 0;//시도 횟수
