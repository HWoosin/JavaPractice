...
public abstract class HeadStore {
	 ...
	 * 	메서드의 바디 ({})부분이 없고, 세미콜론으로 메서드 선언을 마감.
	 * 
	 * 3. 일반 클래스에서는 추상 메서드를 선언할 수 없다. 추상 메서드가 
	 * 	하나라도 존재하는 경우에는 반드시 해당 클래스를 추상 클래스로 선언해야 한다.
	 * 
	 * 4. 추상 클래스에 추상 메서드만을 선언할 필요는 없습니다.
	 * 	일반 멤버변수 및 메서드도 얼마든지 선언이 가능.
	 */
	...
	public void orderWatermelon() {
		System.out.println("수박 쥬스의 가격은 4000원");
	}
