...
public class PrintExample {
	...
	public static void main(String[] args) {
		...
		//서식 문자를 이용해서 문자열을 완성 후, 서식 문자에 들어갈 값을 출력하는 방식.
		 ...
		 * 탈출 코드(escape code) -> print, println, printf 다 쓰인다
		 * 반드시 문자열""내에 위치
		...
		//%.[자릿수를 지정하는 숫자]f -> 원하는 자릿수 까지 표현
		//%라는 문자 자체를 표현할 때는 %% 사용
		double rate = 64.126;
		System.out.printf("합격률은 %.3f%%입니다.\n", rate);
