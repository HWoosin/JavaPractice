...
public class ArrayBasic {
	...
	public static void main(String[] args) {
		...
		arr[1] =88;
		arr[2] =arr[0];
		arr[3] =(int)3.14; //(x) 동종모음, 같은 자료형끼리 모아야한다.
		//		arr[4] ="문자도 안들어가죠";
		arr[4] =100;
		//		arr[5] =77; (x) arr의 범위를 벗어남
		...
		//6. 배열의 반복문 처리
		//배열은 인덱스 번호를 제어변수로 활용하여 쉽게 반복문을 처리할수 있다.
		/*
		int idx =0;
		...
		System.out.println(arr);//배열주소
		System.out.println(Arrays.toString(arr)); //arr내부 확인 가능한 메소드
		...
		//만약 배열의 크기를 늘리거나 줄이고 싶으면, 기존의 배열을 조작하는 것이 아니라 새롭게 생성해야한다.
		String[] names = {"홍길동", "김철수", "황우신"};
		names = new String[] {"홍길동", "김철수", "황우신", "이응애"};
//		names = {"홍길동", "김철수", "황우신", "이응애"}; (x) 크기가 고정이 되어있기 때문
